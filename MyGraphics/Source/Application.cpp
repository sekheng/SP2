...
void Application::Init()
{
    ...
    //m_window = glfwCreateWindow(mode->width, mode->height, "Space Watch", NULL, NULL);
    m_window = glfwCreateWindow(mode->width, mode->height, "Space Watch", glfwGetPrimaryMonitor(), NULL);
